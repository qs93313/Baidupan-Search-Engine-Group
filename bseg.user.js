	...
	if(t < 100) {
		...
		if(find_or) {
			...
			if(find_home) {
				...
				//设置新建的选择框的样式
				new_select.style.cssText = "font-size:15px;height:30px;color:black;border-right:0;";
				//设置新建的输入框的样式
				new_input.style.cssText = "font-size:15px;width:240px;height: 22px;color:black;padding:2px;";
				new_input.focus();
			} else if(find_init) {
				//密码填写页
				...
				//设置新建的选择框的样式
				new_select.style.cssText = "font-size:15px;height:30px;color:black;display:inline-block;margin:5px 0 0 0;border-right:0;";
				//设置新建的输入框的样式
				...
				new_select.style.cssText = "font-size:15px;height:30px;color:black;border-right:0;";
				//设置新建的输入框的样式
				new_input.style.cssText = "font-size:15px;width:250px;height: 22px;color:black;padding:2px;";
				new_input.focus();
